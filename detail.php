...
<tr>
<td>
<table border="0" width="600px" height="400px" align="center" style="margin-top: 50px">
<script type="text/javascript">
...
<tr><td  colspan="3" height="90px"><span class="middletext">Category:</span><span style="margin-left: 38px"><?php echo $data[10];?></span>
 <br/>
  <span class="middletext">Subcategory:</span><span style="margin-left: 11px"><?php echo $data[12];?></span>
        <br />
   <span class="middletext">Price (ALL):</span><span style="margin-left: 5px"><?php echo $data[4];?></span>
</td></tr>
<tr><td colspan="3"><p><?php echo $data[8];?></p></td></tr>
<tr><td align="left" colspan="2" height="50px">
    <input type="button" value="Enquiry" onclick="window.location.href='enquiry.php?pid=<?php echo $data[0]; ?>'" name="sbmt">
</td></tr>
</table>
</td>
</tr>
